      ...
      <div className="space-y-6">
        <Card title="Profile">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div><Label>Full name</Label><Input defaultValue="Jordan Lee" className="mt-1.5" /></div>
            <div><Label>Email</Label><Input defaultValue="jordan@uni.edu" className="mt-1.5" /></div>
            <div className="sm:col-span-2"><Label>University</Label><Input defaultValue="Stanford University" className="mt-1.5" /></div>
          </div>
        </Card>
