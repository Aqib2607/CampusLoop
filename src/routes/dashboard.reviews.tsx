...
const reviews = [
  { id: 1, name: "Priya Shah", avatar: "https://i.pravatar.cc/100?img=5", rating: 5, text: "Great communication and fast handover. Highly recommend!", date: "2 days ago" },
  { id: 2, name: "Marco Diaz", avatar: "https://i.pravatar.cc/100?img=12", rating: 5, text: "Item was even better than described. Will buy again.", date: "1 week ago" },
  { id: 3, name: "Yuki Tanaka", avatar: "https://i.pravatar.cc/100?img=20", rating: 4, text: "Solid deal. Slight delay on the pickup time.", date: "2 weeks ago" },
];
          ...
          <div key={r.id} className="rounded-2xl bg-card border border-border p-5">
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-0.5">
                {Array.from({ length: r.rating }).map((_, i) => <Star key={i} className="h-3.5 w-3.5 fill-warning text-warning" />)}
              </div>
            </div>
